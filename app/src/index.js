...
const App = {
  ...
  lookUp: async function () {
    ...
    if (starName) {
      App.setStatus("The Star Name with id " + starID + " is: " + starName);
    } else {
      App.setStatus("Unable to find a Star with id: " + starID);
    }  
  }
...
window.addEventListener("load", async function() {
  if (window.ethereum) {
    ...
    // fallback - use a fallback strategy (local node / hosted node + in-dapp id mgmt / fail)
